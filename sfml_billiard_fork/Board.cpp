 ...
 Board:: Board(void)
{
	...
	// 당구대 경계 초기화 - 상하좌우
	 ...
	 Board::Border lineTopR(983.5f, 55.f, 998.5f, 40.f);
	...
	borderLines.push_back(lineTopR);
	 ...
	 Board::Border lineTopRight(997.5f, 69.5f, 997.5f, 443.5f);
	...
	borderLines.push_back(lineTopRightR);
	 ...
	 Board::Border lineDownRight(997.5f, 466.5f, 997.5f, 830.5f);
	...
	borderLines.push_back(lineDownRightR);
	 ...
	 Board::Border lineDownR(616.5f, 845.f, 602.5f, 860.5f);
