 ...
 Board:: Board(void)
{
	...
	// 당구대 경계 초기화 - 상하좌우
	 ...
	 Board::Border lineTop(620.f, 55.f, 980.5, 55.f);
	...
	borderLines.push_back(lineTopR);
	 ...
	 Board::Border lineTopRight(997.5f, 72.5f, 997.5f, 443.5f);
	...
	borderLines.push_back(lineTopRightR);
	 ...
	 Board::Border lineDownRight(997.5f, 466.5f, 997.5f, 827.5f);
	...
	borderLines.push_back(lineDownLeftR);
	 ...
	 Board::Border lineTopLeft(602.5f, 430.5f, 602.5f, 72.5f);
